...
export class ToasterService {
  ...
  typeSuccess(message: string, tittle?: string) {
    this.toaster.success(message, tittle || 'PPV Technology', {
      timeOut: 3000,
      progressBar: true,
  ...
  typeInfo(message: string, tittle?: string) {
    this.toaster.info(message, tittle || 'PPV Technology', {
      timeOut: 3000,
      progressBar: true,
      progressAnimation: 'increasing',
      positionClass: 'toast-top-right',
  ...
  typeWarning(message: string, tittle?: string) {
    this.toaster.warning(message, tittle || 'PPV Technology', {
      timeOut: 3000,
      progressBar: true,
      progressAnimation: 'increasing',
      positionClass: 'toast-top-right',
  ...
  typeError(message: string, tittle?: string) {
    this.toaster.error(message, tittle || 'PPV Technology', {
      timeOut: 3000,
      progressBar: true,
      progressAnimation: 'increasing',
      positionClass: 'toast-top-right',
